...
export default function BookCard({ book }: { book: Book }) {
    ...
    const handleOnBuy = () => {
        if (!placeOrder || !user) return;
        placeOrder(user.uid, book);
    }
    ...
    return (
        <div className="max-w-sm md:mx-0 mx-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden transform transition duration-300 ease-in-out hover:scale-105">
            ...
            <div className="p-5">
                ...
                <button onClick={handleOnBuy} className="inline-flex mt-3 items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Buy Now
